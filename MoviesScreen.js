...
export default function BrowseMovies() {
    ...
    useEffect(() =>{
        getTrendingMoviesFromApi(moviePageCounter);
    }, []);
    
    function getTrendingMoviesFromApi(page) {
        setTrendingMovies([]);
        var url = 'https://api.themoviedb.org/3/trending/movie/week?api_key=a7d26cbde2c4cc637772c32299352a9f&page=' + page;
        fetch(url)
            ...
            <TouchableOpacity style={styles.touchButton}
                onPress={() => {
                    if(moviePageCounter > 1) {
                        getTrendingMoviesFromApi(moviePageCounter - 1);
